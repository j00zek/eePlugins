...
from emukodislink.stream import Stream
from emukodislink.stream.stream import StreamIO
from emukodislink.utils import NamedPipe
from emukodislink.compat import devnull
import logging

log = logging.getLogger(__name__)

class HLSDL(StreamIO):
    __commands__ = ['hlsdl4emukodislink', 'hlsdl']
