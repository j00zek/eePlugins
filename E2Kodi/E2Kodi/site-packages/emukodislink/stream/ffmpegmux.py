...
from emukodislink import StreamError
from emukodislink.stream.stream import Stream, StreamIO
from emukodislink.utils.named_pipe import NamedPipe, NamedPipeBase
from emukodislink.utils.processoutput import ProcessOutput
...
class MuxedStream(Stream, Generic[TSubstreams_co]):
    ...
    def __init__(
        ...
        **options,
        ...
        """
        :param emukodislink.Streamlink session: Streamlink session instance
...
class FFMPEGMuxer(StreamIO):
    ...
    def __init__(self, session, *streams, **options):
        ...
        deckey = session.options.get("decryption-key")
        deckey2 = session.options.get("decryption-key-2") or deckey #https://github.com/ImAleeexx/streamlink-drm/commit/5c5d7cdd6e05633ca5c31836ea822c900476e0b0
        cur_deckey = deckey
        ...
        for np in self.pipes:
            if cur_deckey:
                ...
                if cur_deckey == deckey:
                    ...
                    cur_deckey = deckey
            self._cmd.extend(['-thread_queue_size', '32768']) # CZY POTRZEBNE? https://github.com/ImAleeexx/streamlink-drm/commit/d5c70d2224d818530d86b72d555537c46726f28e
