...
from emukodislink.webbrowser.cdp.connection import CDPConnection, CDPSession
from emukodislink.webbrowser.cdp.devtools import fetch, network, page, runtime, target
from emukodislink.webbrowser.cdp.exceptions import CDPError
from emukodislink.webbrowser.chromium import ChromiumWebbrowser
...
class CDPClient:
    """
    The public interface around :class:`ChromiumWebbrowser <emukodislink.webbrowser.chromium.ChromiumWebbrowser>`
    and :class:`CDPConnection <emukodislink.webbrowser.cdp.connection.CDPConnection>`.
    ...
    ``emukodislink.webbrowser.cdp.devtools`` package, but be aware that only a subset of the available domains is supported.
    """
    ...
    def launch(
        ...
        2. Initialize a new :class:`CDPConnection <emukodislink.webbrowser.cdp.connection.CDPConnection>`
