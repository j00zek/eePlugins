...
class NoPluginError(StreamlinkError):
    """
    Error raised by :py:meth:`Streamlink.resolve_url() <emukodislink.Streamlink.resolve_url()>`
    and :py:meth:`Streamlink.resolve_url_no_redirect() <emukodislink.Streamlink.resolve_url_no_redirect()>`
...
class NoStreamsError(StreamlinkError):
    """
    Plugins should use this ``Exception`` in :py:meth:`Plugin._get_streams() <emukodislink.plugin.Plugin._get_streams()>`
