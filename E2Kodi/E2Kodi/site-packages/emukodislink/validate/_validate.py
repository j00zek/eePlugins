...
from emukodislink.exceptions import PluginError
from emukodislink.validate._exception import ValidationError
from emukodislink.validate._schemas import (
    AllSchema,
    AnySchema,
    AttrSchema,
    GetItemSchema,
...
class Schema(AllSchema):
    ...
    which by default raises :class:`PluginError <emukodislink.exceptions.PluginError>` on error.
    """
