...
class OptionalSchema:  # noqa: B903
    ...
    See the :func:`dict <emukodislink.plugin.api.validate.validate_dict>` validation and the :class:`UnionSchema`.
    """
...
class ListSchema(_CollectionSchemaContainer):
    ...
    and the :func:`list <emukodislink.plugin.api.validate.validate_sequence()>` validation.
...
class RegexSchema:  # noqa: B903
    ...
    and the :func:`re.Pattern <emukodislink.plugin.api.validate.validate_pattern()>` validation.
