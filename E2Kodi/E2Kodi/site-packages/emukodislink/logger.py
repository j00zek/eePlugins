...
from emukodislink.utils.times import fromlocaltimestamp
...
FORMAT_DATE = "%H:%M:%S"
REMOVE_BASE = ["emukodislink", "emukodislink_cli"]
...
#  then it continues with the parent logger, which means that if the level of `emukodislink.logger.root` was set to "none" and
...
root = logging.getLogger("emukodislink")
