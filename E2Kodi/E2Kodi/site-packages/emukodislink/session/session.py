...
import emukodislink.compat  # noqa: F401
from emukodislink import __version__
from emukodislink.exceptions import NoPluginError, PluginError, StreamlinkDeprecationWarning
from emukodislink.logger import StreamlinkLogger
from emukodislink.options import Options
from emukodislink.plugin.plugin import Plugin
from emukodislink.session.http import HTTPSession
from emukodislink.session.options import StreamlinkOptions
from emukodislink.session.plugins import StreamlinkPlugins
from emukodislink.utils.l10n import Localization
from emukodislink.utils.url import update_scheme
...
class Streamlink:
    ...
    def __init__(
        ...
        *,
        ...
        #: :class:`StreamlinkOptions <emukodislink.session.options.StreamlinkOptions>` is a subclass
        #: of :class:`Options <emukodislink.options.Options>` with special getter/setter mappings.
    ...
    def set_option(self, key: str, value: Any) -> None:
        ...
        This is a convenience wrapper for :meth:`self.options.set() <emukodislink.session.options.StreamlinkOptions.set>`.

        Please see :class:`StreamlinkOptions <emukodislink.session.options.StreamlinkOptions>` for the available options.
    ...
    def get_option(self, key: str) -> Any:
        ...
        This is a convenience wrapper for :meth:`self.options.get() <emukodislink.session.options.StreamlinkOptions.get>`.
    ...
    def streams(self, url: str, options: Options | None = None, **params):
        ...
        :param params: Additional keyword arguments passed to :meth:`Plugin.streams() <emukodislink.plugin.Plugin.streams>`
        :raises NoPluginError: on plugin resolve failure
        :return: A :class:`dict` of stream names and :class:`Stream <emukodislink.stream.Stream>` instances
        """
    ...
    def get_plugins(self):
        ...
        Deprecated in favor of :meth:`plugins.get_loaded() <emukodislink.session.plugins.StreamlinkPlugins.get_loaded>`.
        """
        warnings.warn(
    ...
    def load_builtin_plugins(self):
        ...
        Deprecated in favor of using the :class:`plugins_builtin <emukodislink.session.Streamlink>` keyword argument.
        """
        warnings.warn(
    ...
    def load_plugins(self, path: str) -> bool:
        ...
        Deprecated in favor of :meth:`plugins.load_path() <emukodislink.session.plugins.StreamlinkPlugins.load_path>`.
        """
        warnings.warn(
