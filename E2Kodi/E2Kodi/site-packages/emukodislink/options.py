...
class Argument:
    ...
    def __init__(
        ...
        See the :func:`pluginargument <emukodislink.plugin.pluginargument>` decorator for adding custom plugin arguments.
...
class Arguments(Dict[str, Argument]):
    """
    A collection of :class:`Argument` instances for :class:`Plugin <emukodislink.plugin.Plugin>` classes.

    Should not be called directly, see the :func:`pluginargument <emukodislink.plugin.pluginargument>` decorator.
    """
