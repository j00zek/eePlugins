...
from emukodislink_cli.console import ConsoleOutput, ConsoleOutputStream, ConsoleUserInputRequester
from emukodislink_cli.console.progress import Progress
from emukodislink_cli.constants import (
    CONFIG_FILES,
...
def setup(parser: ArgumentParser) -> None:
    ...
    setup_plugins(emukodislink, not args.no_plugin_sideloading, args.plugin_dirs)
