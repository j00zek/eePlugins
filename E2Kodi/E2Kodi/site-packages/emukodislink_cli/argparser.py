...
from emukodislink import __version__ as emukodislink_version, logger
from emukodislink.exceptions import StreamlinkDeprecationWarning
from emukodislink.options import Options
from emukodislink.plugin import Plugin
from emukodislink.session import Streamlink
from emukodislink.user_input import UserInputRequester
from emukodislink.utils.args import boolean, comma_list, comma_list_filter, filesize, keyvalue, num
from emukodislink.utils.times import hours_minutes_seconds_float
from emukodislink_cli.constants import STREAM_PASSTHROUGH
from emukodislink_cli.exceptions import StreamlinkCLIError
from emukodislink_cli.output.player import PlayerOutput
from emukodislink_cli.utils import find_default_player
...
class ArgumentParser(argparse.ArgumentParser):
    ...
    def _match_argument(self, action, arg_strings_pattern):
        # - https://github.com/emukodislink/emukodislink/issues/971
...
def build_parser():
    parser = ArgumentParser(
        ...
        epilog=dedent("""
            For more in-depth documentation see:
              https://emukodislink.github.io/

            Please report broken plugins or bugs to the issue tracker on GitHub:
              https://github.com/emukodislink/emukodislink/issues
        """),
    )
    ...
    general.add_argument(
        ...
        "--version",
        action="version",
        version=f"%(prog)s {emukodislink_version}",
        help="""
    ...
    logging.add_argument(
        ...
        help="""
            ...
            Windows:
              ...
              %%TEMP%%\\emukodislink\\logs

            macOS:

              ${HOME}/Library/Logs/emukodislink

            Linux/BSD:

              ${XDG_STATE_HOME:-${HOME}/.local/state}/emukodislink/logs
        """,
    )
    logging.add_argument(
        "-Q",
    ...
    transport_ffmpeg.add_argument(
       ...
       Use a CENC decryption key to decrypt the media that ffmpeg receives as
        an input from the DASH streaming that you play with emukodislink.
