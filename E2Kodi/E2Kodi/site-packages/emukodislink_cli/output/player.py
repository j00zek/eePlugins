...
from emukodislink.compat import is_win32
from emukodislink.exceptions import StreamlinkWarning
from emukodislink.utils.named_pipe import NamedPipeBase
from emukodislink_cli.output.abc import Output
from emukodislink_cli.output.file import FileOutput
from emukodislink_cli.output.http import HTTPOutput
from emukodislink_cli.utils import Formatter


log = logging.getLogger("emukodislink.cli.output")
...
class PlayerOutput(Output):
            ...
            if playerpath[:1] in ('"', "'"):
                warnings.warn(
                    "\n".join([
                        ...
                        "  https://emukodislink.github.io/migrations.html#player-path-only-player-cli-argument",
                    ]),
                    StreamlinkWarning,
                    stacklevel=1,
                )
    ...
    def _close(self):
        ...
        if self.namedpipe:
            ...
            if self.player.poll() is None: self.player.communicate(input="q\n")[0] # j00zek to flush dvb buffer
            self.http.shutdown()
