...
def addDirectoryItems(handle, listitems, totalItems=40):
    """Callback function to pass directory contents back to XBMC as a list."""
    plug = xbmcaddon.getaddonpath_params("addon_id")
    for listitem in listitems:
        addDirectoryItem(handle, listitem[0], listitem[1], isFolder=listitem[2])
    return True
...
def getSetting(handle, id): #https://xbmc.github.io/docs.kodi.tv/master/kodi-base/d1/d32/group__python__xbmcplugin.html#ga8739303a25018f275578b17e35602793
