...
if __name__ == '__main__':
    if len(params) <1:
        ...
        if mode=='listE2B':
            ...
            xbmcgui.Dialog().notification('PolsatBox Go', 'Generuję listę E2B.', xbmcgui.NOTIFICATION_INFO)
            chans=getTVList()
            if chans:
                ...
                f.write(dataE2)
                f.close()
                xbmcgui.Dialog().notification('PolsatBox Go', 'Wygenerowano listę E2B', xbmcgui.NOTIFICATION_INFO)
