<settings>
    ...
    <category label="30011">
        ...
        <setting id="proxy_mpdalter" type="bool" label="30248" default="false" visible="eq(-26,3)"/>
    ...
    <category label="30021">
        <setting id="proxy_mpdalter" type="bool" label="30248" default="false" visible="false"/>
        <!-- Audio -->
    ...
    <category label="30273">
        ...
        <setting id="pv_episode_thumbnails" type="bool" label="30249" visible="eq(-15,0)" default="false"/>
        ...
        <setting id="useshowfanart" type="bool" label="30055" default="false" visible="eq(-18,1)"/>
