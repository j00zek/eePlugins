...
def PlayVideo(name, asin, adultstr, streamtype, forcefb=0):
    ...
    def _IStreamPlayback(asin, name, streamtype, isAdult, extern):
        ...
        if 1: #j00zek 4 e2kodi list(map(int, is_version.split('.'))) < [22, 1, 5]:
        ...
        if 1: #j00zek 4 e2kodi else:
            ...
            listitem.setProperty('inputstream.adaptive.drm', drm_cfg) #j00zek 4 e2kodi json.dumps(drm_cfg))
