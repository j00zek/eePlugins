...
from emukodi.xbmcgui import DialogProgress, DialogProgressBG

try:  # Kodi v19 or newer
    from emukodi.xbmcvfs import translatePath
except ImportError:  # Kodi v18 and older
    # pylint: disable=ungrouped-imports
    from emukodi.xbmc import translatePath
...
def ok_dialog(heading='', message=''):
    ...
    from emukodi.xbmcgui import Dialog
    if not heading:
        heading = ADDON.getAddonInfo('name')
    if kodi_version_major() < 19:
