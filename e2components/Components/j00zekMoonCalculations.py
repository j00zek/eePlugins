...
#
# mods by j00zek:
#  - use datetime instead of DateTime for calculations
#  - make script working anywhere by removel of presentations code
...
from math import sin, cos, floor, sqrt, pi, tan, atan, pow, copysign # asin, atan2
import bisect
import datetime
...
if __name__ == '__main__':
    m = MoonPhase()
    s = """The moon is %s (%s), %.1f%% illuminated, %.1f days old.""" %\
        (m.phase_text, m.phase, m.illuminated * 100, m.age)
    print (s)
