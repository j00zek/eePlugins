...
logging.basicConfig(filename='/tmp/daikin_Aircon.log', level=logging.NOTSET)
...
class Aircon():
    ...
    def get_name(self):
        return self.get_basic_info().get('name', '')
    ...
    def send_request(self, method, url, fields=None, headers=None, **urlopen_kw):
        ...
        if self._http_conn is None:
            ...
            self._http_conn = urllib3.PoolManager(timeout=timeout)
