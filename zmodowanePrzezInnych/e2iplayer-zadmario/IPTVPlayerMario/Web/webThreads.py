...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import GetHostsList, IsHostEnabled, SaveHostsOrderList, SortHostsList, GetLogoDir, GetHostsOrderList, getDebugMode, formatBytes, printDBG
    ...
    def run(self):
        ...
        for hostName in SortHostsList(GetHostsList()):
            ...
            if len(OptionsList) == 0:
                ...
                for item in self.buildSettingsTable(List2=OptionsList, List1=config.plugins.IPTVPlayerMario.dict().items(), exclList=usedCFG, direction='2>1'):
        ...
        for item in self.buildSettingsTable(List1=config.plugins.IPTVPlayerMario.dict().items(), List2=OptionsList, exclList=usedCFG, direction='2>1'):
