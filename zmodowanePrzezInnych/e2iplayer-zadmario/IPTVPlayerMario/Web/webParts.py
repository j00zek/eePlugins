...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import GetHostsList, IsHostEnabled, SaveHostsOrderList, SortHostsList, GetLogoDir, GetHostsOrderList, getDebugMode, formatBytes
#### e2 imports
...
def IncludeMENU(MenuStatusMSG='', ShowCancelButton=False):
    if isActiveHostInitiated():
        tempText = """
  <div class="topbar">
    <a href="http://iptvplayer.vline.pl/" target="_blank"> <img border="0" alt='IPTVPlayerMario' src="./icons/iptvlogo.png" width="60" height="24"></a>
