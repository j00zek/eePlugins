...
###################################################
config.plugins.IPTVPlayerMario.losmovies_proxy = ConfigSelection(default="None", choices=[("None", _("None")),
...
def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("Use proxy server:"), config.plugins.IPTVPlayerMario.losmovies_proxy))
    return optionList
###################################################
...
class LosMovies(CBaseHostClass):
    ...
    def getPage(self, baseUrl, addParams={}, post_data=None):
        ...
        proxy = config.plugins.IPTVPlayerMario.losmovies_proxy.value
        printDBG(">> " + proxy)
        if proxy != 'None':
            if proxy == 'proxy_1':
