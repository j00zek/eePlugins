...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, byteify, rm, MergeDicts
...
###################################################
config.plugins.IPTVPlayerMario.vumedicom_login = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.vumedicom_password = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("login") + ":", config.plugins.IPTVPlayerMario.vumedicom_login))
    optionList.append(getConfigListEntry(_("password") + ":", config.plugins.IPTVPlayerMario.vumedicom_password))
    return optionList
###################################################
...
class VUMEDI(CBaseHostClass):
    ...
    def tryTologin(self):
        ...
        if None == self.loggedIn or self.login != config.plugins.IPTVPlayerMario.vumedicom_login.value or\
            self.password != config.plugins.IPTVPlayerMario.vumedicom_password.value:

            self.login = config.plugins.IPTVPlayerMario.vumedicom_login.value
            self.password = config.plugins.IPTVPlayerMario.vumedicom_password.value
