...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, GetDefaultLang, rm
...
class Dailymotion(CBaseHostClass):
    ...
    def getLocale(self):
        locale = config.plugins.IPTVPlayerMario.dailymotion_localization.value
        if 'auto' != locale:
            return locale
