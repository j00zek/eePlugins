...
###################################################
config.plugins.IPTVPlayerMario.dixmax_login = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.dixmax_password = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("login"), config.plugins.IPTVPlayerMario.dixmax_login))
    optionList.append(getConfigListEntry(_("password"), config.plugins.IPTVPlayerMario.dixmax_password))
    return optionList
###################################################
...
class DixMax(CBaseHostClass):
    ...
    def tryTologin(self):
        ...
        if None == self.loggedIn or self.login != config.plugins.IPTVPlayerMario.dixmax_login.value or\
            self.password != config.plugins.IPTVPlayerMario.dixmax_password.value:

            loginCookie = GetCookieDir('dixmax.com.login')
            self.login = config.plugins.IPTVPlayerMario.dixmax_login.value
            self.password = config.plugins.IPTVPlayerMario.dixmax_password.value
