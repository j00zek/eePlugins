...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printExc, CSelOneLink
...
####################################################
config.plugins.IPTVPlayerMario.MusicBox_premium = ConfigYesNo(default=False)
config.plugins.IPTVPlayerMario.MusicBox_login = ConfigText(default="", fixed_size=False)
####################################################
# Api keys
####################################################
...
def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry("Użytkownik Last.fm", config.plugins.IPTVPlayerMario.MusicBox_premium))
    if config.plugins.IPTVPlayerMario.MusicBox_premium.value:
        optionList.append(getConfigListEntry(" Last.fm login:", config.plugins.IPTVPlayerMario.MusicBox_login))
    return optionList
...
class MusicBox(CBaseHostClass):
    ...
    def __init__(self):
        ...
        self.ytformats = config.plugins.IPTVPlayerMario.ytformat.value
        self.ytp = YouTubeParser()
        self.lastfm_username = config.plugins.IPTVPlayerMario.MusicBox_login.value
        self.usePremiumAccount = config.plugins.IPTVPlayerMario.MusicBox_premium.value
