...
###################################################
config.plugins.IPTVPlayerMario.rtlmosthu_login = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.rtlmosthu_password = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("Email") + ":", config.plugins.IPTVPlayerMario.rtlmosthu_login))
    optionList.append(getConfigListEntry(_("password") + ":", config.plugins.IPTVPlayerMario.rtlmosthu_password))
    return optionList
###################################################
...
class RtlMostHU(CBaseHostClass):
    ...
    def __init__(self):
        ...
        self.login = config.plugins.IPTVPlayerMario.rtlmosthu_login.value
        self.password = config.plugins.IPTVPlayerMario.rtlmosthu_password.value
    ...
    def tryTologin(self):
        ...
        needLogin = False
        if self.login != config.plugins.IPTVPlayerMario.rtlmosthu_login.value or self.password != config.plugins.IPTVPlayerMario.rtlmosthu_password.value:
            needLogin = True
            self.login = config.plugins.IPTVPlayerMario.rtlmosthu_login.value
            self.password = config.plugins.IPTVPlayerMario.rtlmosthu_password.value
