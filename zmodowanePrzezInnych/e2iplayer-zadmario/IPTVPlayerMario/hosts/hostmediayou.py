...
###################################################
config.plugins.IPTVPlayerMario.mediayou_language = ConfigSelection(default="pol", choices=[("pol", _("Polish")), ("eng", _("English")), ("ger", _("Deutsch")), ("rus", _("Russian")), ("ita", _("Italian")), ("fre", _("French"))])


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("Language"), config.plugins.IPTVPlayerMario.mediayou_language))
    return optionList
###################################################
...
class MediayouNet(CBaseHostClass):
    ...
    def __init__(self):
        ...
        self.countryCode = config.plugins.IPTVPlayerMario.mediayou_language.value
