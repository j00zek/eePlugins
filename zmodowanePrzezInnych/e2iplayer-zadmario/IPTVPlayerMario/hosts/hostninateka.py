...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, CSearchHistoryHelper, printExc, byteify
...
class Ninateka(CBaseHostClass):
    ...
    def listSearchResult(self, cItem, searchPattern, searchType):
        ...
        self.getVideosList(self.SEARCH_URL + urllib_quote_plus(searchPattern))
