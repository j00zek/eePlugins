...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, formatBytes, byteify
...
###################################################
config.plugins.IPTVPlayerMario.Chomikuj_folder = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.Chomikuj_password = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.Chomikuj_login = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []

    optionList.append(getConfigListEntry("Folder startu", config.plugins.IPTVPlayerMario.Chomikuj_folder))
    optionList.append(getConfigListEntry("Nazwa chomika (login)", config.plugins.IPTVPlayerMario.Chomikuj_login))
    optionList.append(getConfigListEntry("Hasło do chomika", config.plugins.IPTVPlayerMario.Chomikuj_password))
...
class Chomikuj(CBaseHostClass):
    ...
    def requestLoginData(self):
        ...
        login = config.plugins.IPTVPlayerMario.Chomikuj_login.value
        password = config.plugins.IPTVPlayerMario.Chomikuj_password.value
