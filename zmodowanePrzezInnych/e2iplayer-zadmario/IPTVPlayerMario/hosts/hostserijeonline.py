...
###################################################
config.plugins.IPTVPlayerMario.serijeonline_login = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.serijeonline_password = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("login") + ":", config.plugins.IPTVPlayerMario.serijeonline_login))
    optionList.append(getConfigListEntry(_("password") + ":", config.plugins.IPTVPlayerMario.serijeonline_password))
    return optionList
###################################################
...
class SerijeOnline(CBaseHostClass):
    ...
    def tryTologin(self):
        ...
        if None == self.loggedIn or self.login != config.plugins.IPTVPlayerMario.serijeonline_login.value or\
            self.password != config.plugins.IPTVPlayerMario.serijeonline_password.value:

            self.login = config.plugins.IPTVPlayerMario.serijeonline_login.value
            self.password = config.plugins.IPTVPlayerMario.serijeonline_password.value
