...
config.plugins.IPTVPlayerMario.hdstreams_linkcache = ConfigYesNo(default=True)
config.plugins.IPTVPlayerMario.hdstreams_bypassrecaptcha = ConfigSelection(default="None", choices=[("None", _("None")),
                                                                                                 ("9kw.eu", "https://9kw.eu/"),
...
def GetConfigList():
    optionList = []
    #optionList.append(getConfigListEntry(_("Use links cache"), config.plugins.IPTVPlayerMario.hdstreams_linkcache))
    #optionList.append(getConfigListEntry(_("Captcha solving service"), config.plugins.IPTVPlayerMario.hdstreams_bypassrecaptcha))
    #if config.plugins.IPTVPlayerMario.hdstreams_bypassrecaptcha.value == '9kw.eu':
    #    optionList.append(getConfigListEntry(_("%s API KEY") % '    ', config.plugins.IPTVPlayerMario.api_key_9kweu))
    #elif config.plugins.IPTVPlayerMario.hdstreams_bypassrecaptcha.value == '2captcha.com':
