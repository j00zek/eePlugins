...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, GetLogoDir
...
config.plugins.IPTVPlayerMario.grupujurllist = ConfigYesNo(default=True)
config.plugins.IPTVPlayerMario.sortuj = ConfigYesNo(default=True)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_('Text files ytlist and urllist are in:'), config.plugins.IPTVPlayerMario.Sciezkaurllist))
    optionList.append(getConfigListEntry(_('Sort the list:'), config.plugins.IPTVPlayerMario.sortuj))
    optionList.append(getConfigListEntry(_('Group links into categories: '), config.plugins.IPTVPlayerMario.grupujurllist))
    return optionList
###################################################
...
class Urllist(CBaseHostClass):
    ...
    def __init__(self):
        ...
        path = config.plugins.IPTVPlayerMario.Sciezkaurllist.value + '/'
    ...
    def listCategory(self, cItem, searchMode=False):
        ...
        sortList = config.plugins.IPTVPlayerMario.sortuj.value
        filespath = config.plugins.IPTVPlayerMario.Sciezkaurllist.value
        groupList = config.plugins.IPTVPlayerMario.grupujurllist.value
