...
###################################################
from Plugins.Extensions.IPTVPlayerMario.p2p3.UrlLib import urllib_unquote, urllib_quote_plus
###################################################
# FOREIGN import
###################################################
import re
...
###################################################
config.plugins.IPTVPlayerMario.ngolos_language = ConfigSelection(default="en", choices=[("en", _("English")), ("es", _("Spanish")), ("pt", _("Portuguese"))])


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("Language:"), config.plugins.IPTVPlayerMario.ngolos_language))
    return optionList
###################################################
...
class NGolosCOM(CBaseHostClass):
    ...
    def getPage(self, baseUrl, addParams={}, post_data=None):
        ...
        lang = config.plugins.IPTVPlayerMario.ngolos_language.value
