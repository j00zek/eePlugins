...
###################################################
config.plugins.IPTVPlayerMario.nuteczki_login = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.nuteczki_password = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("login"), config.plugins.IPTVPlayerMario.nuteczki_login))
    optionList.append(getConfigListEntry(_("password"), config.plugins.IPTVPlayerMario.nuteczki_password))
    return optionList
###################################################
...
class NuteczkiEU(CBaseHostClass):
    ...
    def tryTologin(self):
        ...
        if None == self.loggedIn or self.login != config.plugins.IPTVPlayerMario.nuteczki_login.value or\
            self.password != config.plugins.IPTVPlayerMario.nuteczki_password.value:

            self.login = config.plugins.IPTVPlayerMario.nuteczki_login.value
            self.password = config.plugins.IPTVPlayerMario.nuteczki_password.value
