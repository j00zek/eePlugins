...
###################################################
config.plugins.IPTVPlayerMario.maxtvgo_login = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.maxtvgo_password = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("login") + ":", config.plugins.IPTVPlayerMario.maxtvgo_login))
    optionList.append(getConfigListEntry(_("password") + ":", config.plugins.IPTVPlayerMario.maxtvgo_password))
    return optionList
###################################################
...
class MaxtvGO(CBaseHostClass):
    ...
    def tryTologin(self):
        ...
        if None == self.loggedIn or self.login != config.plugins.IPTVPlayerMario.maxtvgo_login.value or\
            self.password != config.plugins.IPTVPlayerMario.maxtvgo_password.value:

            self.login = config.plugins.IPTVPlayerMario.maxtvgo_login.value
            self.password = config.plugins.IPTVPlayerMario.maxtvgo_password.value
