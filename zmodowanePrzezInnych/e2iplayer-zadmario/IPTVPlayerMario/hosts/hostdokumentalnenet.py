...
###################################################
config.plugins.IPTVPlayerMario.plusdede_login = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.plusdede_password = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("login") + ":", config.plugins.IPTVPlayerMario.plusdede_login))
    optionList.append(getConfigListEntry(_("password") + ":", config.plugins.IPTVPlayerMario.plusdede_password))
    return optionList
###################################################
