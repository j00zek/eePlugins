...
from Plugins.Extensions.IPTVPlayerMario.components.ihost import IHost, CHostBase, CBaseHostClass, CDisplayListItem, RetHost, CUrlItem, CFavItem
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, GetLogoDir, GetFavouritesDir, mkdirs, rm, touch
from Plugins.Extensions.IPTVPlayerMario.tools.iptvfavourites import IPTVFavourites
...
###################################################
config.plugins.IPTVPlayerMario.favourites_use_watched_flag = ConfigYesNo(default=True)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("Allow watched flag to be set"), config.plugins.IPTVPlayerMario.favourites_use_watched_flag))
    if config.plugins.IPTVPlayerMario.favourites_use_watched_flag.value:
        optionList.append(getConfigListEntry(_("The color of the viewed item"), config.plugins.IPTVPlayerMario.watched_item_color))
    return optionList
###################################################
...
class IPTVHost(CHostBase):
    ...
    def __init__(self):
        ...
        self.cachedRet = None
        self.useWatchedFlag = config.plugins.IPTVPlayerMario.favourites_use_watched_flag.value
