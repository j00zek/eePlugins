...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, rm, NextDay, PrevDay
...
###################################################
config.plugins.IPTVPlayerMario.eurosportplayer_login = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.eurosportplayer_password = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("e-mail") + ":", config.plugins.IPTVPlayerMario.eurosportplayer_login))
    optionList.append(getConfigListEntry(_("password") + ":", config.plugins.IPTVPlayerMario.eurosportplayer_password))
    return optionList
###################################################
...
class EuroSportPlayer(CBaseHostClass):
    ...
    def checkLogin(self):
        ...
        if sts:
            ...
            if data['data']['attributes']['anonymous']:
                ...
                if config.plugins.IPTVPlayerMario.eurosportplayer_login.value != data['data']['attributes']['username']:
    ...
    def tryTologin(self):
        ...
        if None == self.loggedIn or self.login != config.plugins.IPTVPlayerMario.eurosportplayer_login.value or\
            self.password != config.plugins.IPTVPlayerMario.eurosportplayer_password.value:

            self.login = config.plugins.IPTVPlayerMario.eurosportplayer_login.value
            self.password = config.plugins.IPTVPlayerMario.eurosportplayer_password.value
