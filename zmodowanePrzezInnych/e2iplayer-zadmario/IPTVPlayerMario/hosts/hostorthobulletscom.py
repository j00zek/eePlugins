...
###################################################
config.plugins.IPTVPlayerMario.orthobulletscom_login = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.orthobulletscom_password = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("login") + ":", config.plugins.IPTVPlayerMario.orthobulletscom_login))
    optionList.append(getConfigListEntry(_("password") + ":", config.plugins.IPTVPlayerMario.orthobulletscom_password))
    return optionList
###################################################
...
class OrthoBullets(CBaseHostClass):
    ...
    def tryTologin(self):
        ...
        if None == self.loggedIn or self.login != config.plugins.IPTVPlayerMario.orthobulletscom_login.value or\
            self.password != config.plugins.IPTVPlayerMario.orthobulletscom_password.value:

            self.login = config.plugins.IPTVPlayerMario.orthobulletscom_login.value
            self.password = config.plugins.IPTVPlayerMario.orthobulletscom_password.value
