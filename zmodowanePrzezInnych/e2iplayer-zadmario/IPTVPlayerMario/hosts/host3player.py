...
import base64
from Plugins.Extensions.IPTVPlayerMario.p2p3.UrlParse import urlparse
...
###################################################
config.plugins.IPTVPlayerMario.tv3player_use_web_proxy = ConfigYesNo(default=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("Use web-proxy for VODs (it may be illegal):"), config.plugins.IPTVPlayerMario.tv3player_use_web_proxy))
    return optionList
###################################################
...
class C3player(CBaseHostClass):
    ...
    def getLinksForVideo(self, cItem):
        ...
        if hlsUrl != '':
            ...
            if embedToken == '' and config.plugins.IPTVPlayerMario.tv3player_use_web_proxy.value:
