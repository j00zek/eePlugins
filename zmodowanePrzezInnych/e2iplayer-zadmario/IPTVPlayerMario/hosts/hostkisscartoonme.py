...
###################################################
config.plugins.IPTVPlayerMario.kisscartoon_defaultformat = ConfigSelection(default="999999", choices=[("0", _("the worst")), ("360", "360p"), ("480", "480p"), ("720", "720p"), ("1080", "1080p"), ("999999", "the best")])


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("Default video quality:"), config.plugins.IPTVPlayerMario.kisscartoon_defaultformat))
    return optionList
###################################################
...
class KissCartoonMe(CBaseHostClass):
    ...
    def getVideoLinks(self, videoUrl):
        ...
        if 0 < len(urlTab):
            max_bitrate = int(config.plugins.IPTVPlayerMario.kisscartoon_defaultformat.value)
