...
# LOCAL import
###################################################
from Plugins.Extensions.IPTVPlayerMario.components.iptvplayerinit import TranslateTXT as _, SetIPTVPlayerLastHostError, GetIPTVPlayerLastHostError
from Plugins.Extensions.IPTVPlayerMario.components.ihost import CHostBase, CBaseHostClass, CDisplayListItem
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, GetTmpDir
...
###################################################
config.plugins.IPTVPlayerMario.streamliveto_login = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.streamliveto_password = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("Login") + ": ", config.plugins.IPTVPlayerMario.streamliveto_login))
    optionList.append(getConfigListEntry(_("Password") + ": ", config.plugins.IPTVPlayerMario.streamliveto_password))
    return optionList
...
class StreamLiveTo(CBaseHostClass):
    ...
    #MAIN MENU
        if name == None:
            login = config.plugins.IPTVPlayerMario.streamliveto_login.value
            passwd = config.plugins.IPTVPlayerMario.streamliveto_password.value
            logged = False
