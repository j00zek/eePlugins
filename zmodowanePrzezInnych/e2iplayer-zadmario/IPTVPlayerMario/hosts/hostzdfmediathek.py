...
###################################################
config.plugins.IPTVPlayerMario.zdfmediathek_iconssize = ConfigSelection(default="medium", choices=[("large", _("large")), ("medium", _("medium")), ("small", _("small"))])
config.plugins.IPTVPlayerMario.zdfmediathek_prefformat = ConfigSelection(default="mp4,m3u8", choices=[
("mp4,m3u8", "mp4,m3u8"), ("m3u8,mp4", "m3u8,mp4")])
config.plugins.IPTVPlayerMario.zdfmediathek_prefquality = ConfigSelection(default="4", choices=[("0", _("low")), ("1", _("medium")), ("2", _("high")), ("3", _("very high")), ("4", _("hd"))])
config.plugins.IPTVPlayerMario.zdfmediathek_prefmoreimportant = ConfigSelection(default="quality", choices=[("quality", _("quality")), ("format", _("format"))])
config.plugins.IPTVPlayerMario.zdfmediathek_onelinkmode = ConfigYesNo(default=True)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("Icons size"), config.plugins.IPTVPlayerMario.zdfmediathek_iconssize))
    optionList.append(getConfigListEntry(_("Prefered format"), config.plugins.IPTVPlayerMario.zdfmediathek_prefformat))
    optionList.append(getConfigListEntry(_("Prefered quality"), config.plugins.IPTVPlayerMario.zdfmediathek_prefquality))
    optionList.append(getConfigListEntry(_("More important"), config.plugins.IPTVPlayerMario.zdfmediathek_prefmoreimportant))
    optionList.append(getConfigListEntry(_("One link mode"), config.plugins.IPTVPlayerMario.zdfmediathek_onelinkmode))
    return optionList
###################################################
...
class ZDFmediathek(CBaseHostClass):
    ...
    def _getIcon(self, iconsItem):
        iconssize = config.plugins.IPTVPlayerMario.zdfmediathek_iconssize.value
        iconsTab = []
    ...
    def getLinksForVideo(self, cItem):
        ...
        preferedQuality = int(config.plugins.IPTVPlayerMario.zdfmediathek_prefquality.value)
        preferedFormat = config.plugins.IPTVPlayerMario.zdfmediathek_prefformat.value
        ...
        try:
            ...
            def _cmpLinks(it1, it2):
                prefmoreimportantly = config.plugins.IPTVPlayerMario.zdfmediathek_prefmoreimportant.value
            ...
            onelinkmode = config.plugins.IPTVPlayerMario.zdfmediathek_onelinkmode.value
