...
###################################################
config.plugins.IPTVPlayerMario.rtbfbe_login = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.rtbfbe_password = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("e-mail") + ":", config.plugins.IPTVPlayerMario.rtbfbe_login))
    optionList.append(getConfigListEntry(_("password") + ":", config.plugins.IPTVPlayerMario.rtbfbe_password))
    return optionList
###################################################
...
class RTBFBE(CBaseHostClass):
    ...
    def tryTologin(self):
        ...
        if self.login == config.plugins.IPTVPlayerMario.rtbfbe_login.value and \
           self.password == config.plugins.IPTVPlayerMario.rtbfbe_password.value:
           return

        self.login = config.plugins.IPTVPlayerMario.rtbfbe_login.value
        self.password = config.plugins.IPTVPlayerMario.rtbfbe_password.value
