...
def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("Default video quality:"), config.plugins.IPTVPlayerMario.vevo_default_quality))
    optionList.append(getConfigListEntry(_("Use default video quality:"), config.plugins.IPTVPlayerMario.vevo_use_default_quality))
    optionList.append(getConfigListEntry(_("Allow hls format"), config.plugins.IPTVPlayerMario.vevo_allow_hls))
    return optionList
###################################################
