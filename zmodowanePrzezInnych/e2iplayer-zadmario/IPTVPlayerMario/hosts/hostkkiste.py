...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, MergeDicts
...
###################################################
from Plugins.Extensions.IPTVPlayerMario.p2p3.UrlParse import urlsplit, urlunsplit, urlparse
...
###################################################
config.plugins.IPTVPlayerMario.kkiste_proxy = ConfigSelection(default="None", choices=[("None", _("None")),
                                                                                           ("proxy_1", _("Alternative proxy server (1)")),
                                                                                           ("proxy_2", _("Alternative proxy server (2)"))])
config.plugins.IPTVPlayerMario.kkiste_alt_domain = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("Use proxy server:"), config.plugins.IPTVPlayerMario.kkiste_proxy))
    if config.plugins.IPTVPlayerMario.kkiste_proxy.value == 'None':
        optionList.append(getConfigListEntry(_("Alternative domain:"), config.plugins.IPTVPlayerMario.kkiste_alt_domain))
    return optionList
###################################################
...
class KKisteAG(CBaseHostClass):
    ...
    def getPage(self, url, addParams={}, post_data=None):
        ...
        proxy = config.plugins.IPTVPlayerMario.kkiste_proxy.value
        if proxy != 'None':
            if proxy == 'proxy_1':
    ...
    def selectDomain(self):
        ...
        domain = config.plugins.IPTVPlayerMario.kkiste_alt_domain.value.strip()
