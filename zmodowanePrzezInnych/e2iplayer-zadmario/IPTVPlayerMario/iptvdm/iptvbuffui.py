...
# LOCAL import
###################################################
from Plugins.Extensions.IPTVPlayerMario.components.cover import SimpleAnimatedCover
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtypes import strwithmeta, enum
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, formatBytes, touch, eConnectCallback, ReadUint32, GetIPTVDMImgDir
...
from Plugins.Extensions.IPTVPlayerMario.iptvdm.iptvdownloadercreator import DownloaderCreator
...
class E2iPlayerBufferingWidget(Screen):
    ...
    def __init__(self, session, url, pathForBuffering, pathForDownloading, movieTitle, activMoviePlayer, requestedBuffSize, playerAdditionalParams={}, downloadManager=None, fileExtension=''):
        ...
        for idx in range(1, self.NUM_OF_ICON_FRAMES + 1):
            frames.append(resolveFilename(SCOPE_PLUGINS, 'Extensions/IPTVPlayerMario/icons/buffering/buffering_%d.png' % idx))
