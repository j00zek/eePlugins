...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, GetPluginDir, IsExecutable
...
class DMHelper:
    ...
    @staticmethod
    def GET_WGET_PATH():
        return config.plugins.IPTVPlayerMario.wgetpath.value

    @staticmethod
    def GET_F4M_PATH():
        return config.plugins.IPTVPlayerMario.f4mdumppath.value

    @staticmethod
    def GET_HLSDL_PATH():
        return config.plugins.IPTVPlayerMario.hlsdlpath.value
    ...
    def GET_RTMPDUMP_PATH():
        return config.plugins.IPTVPlayerMario.rtmpdumppath.value
