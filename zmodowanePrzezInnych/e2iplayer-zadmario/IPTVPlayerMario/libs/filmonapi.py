...
###################################################
config.plugins.IPTVPlayerMario.filmontvcom_streamprotocol = ConfigSelection(default="rtmp", choices=[("rtmp", "rtmp"), ("rtsp", "rtsp"), ("hls", "HLS - m3u8")])
config.plugins.IPTVPlayerMario.filmontvcom_premium = ConfigYesNo(default=False)
config.plugins.IPTVPlayerMario.filmontvcom_login = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.filmontvcom_password = ConfigText(default="", fixed_size=False)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry("FimOn.com " + _("Preferred streaming protocol") + ": ", config.plugins.IPTVPlayerMario.filmontvcom_streamprotocol))
    optionList.append(getConfigListEntry("FimOn.com " + _("Premium user") + ": ", config.plugins.IPTVPlayerMario.filmontvcom_premium))
    if config.plugins.IPTVPlayerMario.filmontvcom_premium.value:
        optionList.append(getConfigListEntry("  " + _("login") + ": ", config.plugins.IPTVPlayerMario.filmontvcom_login))
        optionList.append(getConfigListEntry("  " + _("password") + ": ", config.plugins.IPTVPlayerMario.filmontvcom_password))
    return optionList
###################################################
...
class FilmOnComApi:
    ...
    def __init__(self):
        ...
        self.streamprotocol = config.plugins.IPTVPlayerMario.filmontvcom_streamprotocol.value
        self.PREMIUM = config.plugins.IPTVPlayerMario.filmontvcom_premium.value
        self.LOGIN = config.plugins.IPTVPlayerMario.filmontvcom_login.value
        self.PASSWORD = config.plugins.IPTVPlayerMario.filmontvcom_password.value
