...
# LOCAL import
###################################################
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, GetCookieDir, byteify, rm
...
###################################################
config.plugins.IPTVPlayerMario.ustvnow_login = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.ustvnow_password = ConfigText(default="", fixed_size=False)
config.plugins.IPTVPlayerMario.ustvnow_only_available = ConfigYesNo(default=True)
config.plugins.IPTVPlayerMario.ustvnow_epg = ConfigYesNo(default=True)


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("Email") + ": ", config.plugins.IPTVPlayerMario.ustvnow_login))
    optionList.append(getConfigListEntry(_("Password") + ": ", config.plugins.IPTVPlayerMario.ustvnow_password))
    optionList.append(getConfigListEntry(_("List only channels with subscription") + ": ", config.plugins.IPTVPlayerMario.ustvnow_only_available))
    optionList.append(getConfigListEntry(_("Get EPG") + ": ", config.plugins.IPTVPlayerMario.ustvnow_epg))
...
class UstvnowApi:
    ...
    def getChannelsList(self, cItem):
        ...
        login = config.plugins.IPTVPlayerMario.ustvnow_login.value
        passwd = config.plugins.IPTVPlayerMario.ustvnow_password.value
        ...
        for item in data:
            ...
            for nameItem in channelsNames:
                if nameItem['img'] in icon:
                    if config.plugins.IPTVPlayerMario.ustvnow_only_available.value and 0 == nameItem['t']:
                        break
        ...
        if config.plugins.IPTVPlayerMario.ustvnow_epg.value:
