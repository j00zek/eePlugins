...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, GetCookieDir
...
###################################################
config.plugins.IPTVPlayerMario.skylinewebcams_lang = ConfigSelection(default="en", choices=[("en", "en"), ("it", "it"), ("es", "es"), ("de", "de"), ("fr", "fr"),
                                                                                           ("el", "el"), ("hr", "hr"), ("sl", "sl"), ("zh", "zh")])


def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry(_("Language:"), config.plugins.IPTVPlayerMario.skylinewebcams_lang))
    return optionList
...
class WkylinewebcamsComApi:
    ...
    def __init__(self):
        ...
        self.cacheList = {}
        self.mainMenuCache = {}
        self.lang = config.plugins.IPTVPlayerMario.skylinewebcams_lang.value
    ...
    def getChannelsList(self, cItem):
        ...
        lang = config.plugins.IPTVPlayerMario.skylinewebcams_lang.value
        self.lang = lang
        if None == cat:
            cItem = dict(cItem)
