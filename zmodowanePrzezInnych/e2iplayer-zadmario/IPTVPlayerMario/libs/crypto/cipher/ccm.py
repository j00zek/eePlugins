...
try:
    ...
    from Plugins.Extensions.IPTVPlayerMario.libs.crypto.cipher.base import BlockCipherWithIntegrity, noPadding
    from Plugins.Extensions.IPTVPlayerMario.libs.crypto.common import xor
...
try:
    ...
    from Plugins.Extensions.IPTVPlayerMario.libs.crypto.errors import InitCryptoError, EncryptError, DecryptError, IntegrityCheckError
