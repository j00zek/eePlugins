...
import re
from Plugins.Extensions.IPTVPlayerMario.libs.youtube_dl.utils import clean_html as yt_clean_html
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printExc
from Plugins.Extensions.IPTVPlayerMario.p2p3.manipulateStrings import ensure_binary, ensure_str
...
def clean_html(string): # str is a keyword in python and should not be used, so changed to string
    ...
    if None == STRIP_HTML_TAGS_C:
        ...
        try:
            from Plugins.Extensions.IPTVPlayerMario.libs.iptvsubparser import _subparser as p
