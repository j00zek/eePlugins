...
#import urllib2
import re
from Plugins.Extensions.IPTVPlayerMario.libs.youtube_dl.utils import *
...
from Plugins.Extensions.IPTVPlayerMario.libs.youtube_dl.jsinterp import JSInterpreter
...
config.plugins.IPTVPlayerMario.vevo_default_quality = ConfigSelection(default="1228800", choices=[
("0", _("the worst")),
("245760", "30 KB/s"),
("655360", "80 KB/s"),
("409600", "50 KB/s"),
...
config.plugins.IPTVPlayerMario.vevo_use_default_quality = ConfigYesNo(default=True)
config.plugins.IPTVPlayerMario.vevo_allow_hls = ConfigYesNo(default=True)
...
class VevoIE(InfoExtractor):
    ...
    def _real_extract2(self, url, hls=None, smil=True):
        ...
        if hls == None:
            hls = config.plugins.IPTVPlayerMario.vevo_allow_hls.value
