...
# LOCAL import
###################################################
from Plugins.Extensions.IPTVPlayerMario.components.cover import SimpleAnimatedCover, Cover
from Plugins.Extensions.IPTVPlayerMario.components.iptvplayerinit import TranslateTXT as _
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, GetIconDir, eConnectCallback, E2PrioFix
...
class IPTVPicturePlayerWidget(Screen):
    ...
    def __init__(self, session, url, pathForRecordings, pictureTitle, addParams={}):
        ...
        if len(self.audioUrl) and len(config.plugins.IPTVPlayerMario.gstplayerpath.value):
