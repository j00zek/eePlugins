...
# LOCAL import
###################################################
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, DownloadFile, eConnectCallback
###################################################
# FOREIGN import
###################################################
...
PluginLanguageDomain = 'IPTVPlayerMario'
PluginLanguagePath = "Extensions/IPTVPlayerMario/locale"
...
class IPTVPlayerNotificationList(object):
    ...
    def push(self, message, type="message", timeout=5, messageHash=None, repeatMessageTimeoutSec=0):
        ...
        with self.mainLock:
            try:
                notification = IPTVPlayerNotification('IPTVPlayerMario', message, type, timeout, messageHash, timestamp)
                if messageHash != None:
                    try:
