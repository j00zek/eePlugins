...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import CSearchHistoryHelper, GetCookieDir, printDBG, printExc, GetLogoDir, byteify
...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import isPY2
if not isPY2():
    basestring = str
######################################################
...
class CDisplayListItem:
    ...
    def getTextColor(self):
        try:
            ...
            if self.isWatched:
                return parseColor(config.plugins.IPTVPlayerMario.watched_item_color.value).argb()
        except Exception:
            printExc()
        return None
