...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, GetIconDir
from Plugins.Extensions.IPTVPlayerMario.components.cover import Cover3
...
class IPTVPinWidget(Screen):
    ...
    skin = """
        <screen name="IPTVPinWidget" position="center,center" title="E2iPlayer" size="300,260">
         ...
         <ePixmap position="100,150" zPosition="4" size="100,100" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/IPTVPlayerMario/icons/Pin/lock.png" transparent="1" alphatest="on" />
        </screen>"""
