...
# LOCAL import
###################################################
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, GetDefaultLang, IsValidFileName, \
...
from Plugins.Extensions.IPTVPlayerMario.components.isubprovider import ISubProvider
...
class IPTVSubDownloaderWidget(Screen):
    ...
    def __init__(self, session, params={}):
        ...
        path = GetSkinsDir(config.plugins.IPTVPlayerMario.skin.value) + "/subplaylist.xml"
