...
from Plugins.Extensions.IPTVPlayerMario.components.asynccall import MainSessionWrapper, iptv_execute
...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import CSearchHistoryHelper, GetCookieDir, printDBG, printExc, GetTmpDir, GetSubtitlesDir, \
                                                          MapUcharEncoding, GetPolishSubEncoding, GetUchardetPath, GetDefaultLang, \
                                                          rm, rmtree, mkdirs
from Plugins.Extensions.IPTVPlayerMario.tools.iptvsubtitles import IPTVSubtitlesHandler
...
class CBaseSubProviderClass:
    ...
    def getTypeFromThemoviedb(self, imdbid, title):
        ...
        try:
            ...
            from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import byteify
