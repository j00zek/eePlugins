...
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, mkdirs, GetDefaultLang, GetIconDir, GetE2iPlayerVKLayoutDir, GetResourcesServerUri
from Plugins.Extensions.IPTVPlayerMario.components.iptvplayerinit import TranslateTXT as _
from Plugins.Extensions.IPTVPlayerMario.components.iptvlist import IPTVListComponentBase
from Plugins.Extensions.IPTVPlayerMario.components.e2isimpledownloader import SingleFileDownloaderWidget
###################################################
from Plugins.Extensions.IPTVPlayerMario.p2p3.pVer import isPY2
from Plugins.Extensions.IPTVPlayerMario.p2p3.Widgets import getWidgetText, innerWidgetTextRight
###################################################
...
class E2iVirtualKeyBoard(Screen):
    ...
    def prepareSkin(self):
        ...
        bg_color = config.plugins.IPTVPlayerMario.osk_background_color.value
    ...
    def __init__(self, session, title="", text="", additionalParams={}):
        ...
        self.selectedVKLayoutId = config.plugins.IPTVPlayerMario.osk_layout.value
    ...
    def __onClose(self):
        ...
        if self.selectedVKLayoutId != config.plugins.IPTVPlayerMario.osk_layout.value:
            config.plugins.IPTVPlayerMario.osk_layout.value = self.selectedVKLayoutId
            config.plugins.IPTVPlayerMario.osk_layout.save()
            configfile.save()
