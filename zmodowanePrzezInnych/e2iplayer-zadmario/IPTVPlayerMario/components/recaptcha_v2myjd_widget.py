...
# LOCAL import
###################################################
from Plugins.Extensions.IPTVPlayerMario.tools.iptvtools import printDBG, printExc, GetIconDir, eConnectCallback, byteify, E2PrioFix, GetPyScriptCmd, getDebugMode, GetPluginDir
...
class UnCaptchaReCaptchaMyJDWidget(Screen):
    ...
    def startExecution(self):
        login = config.plugins.IPTVPlayerMario.myjd_login.value
        password = config.plugins.IPTVPlayerMario.myjd_password.value
        jdname = config.plugins.IPTVPlayerMario.myjd_jdname.value
