...
def getaddonpath_params(item=None):
    ...
    ##addon_path="/usr/lib/enigma2/python/Plugins/Extensions/TSmedia/addons/movies/plugin.video.glomovies" or "/usr/lib/enigma2/python/Plugins/Extensions/TSmedia/plugins/plugin.video.glomovies" for XBMCAddons
    ##section_path="/usr/lib/enigma2/python/Plugins/Extensions/TSmedia/addons/movies"  only for TSmedia
    ##addons_path="/usr/lib/enigma2/python/Plugins/Extensions/TSmedia/addons"  or .../XBMC for xbmcaddons or ..../plugins for XBMCAddons
...
#                      addon_path = addon_path[:(n2+1)]
       ...
       addon_path = addon_path.replace("plugin://", "/usr/lib/python2.7/site-packages/emukodi/plugins")
