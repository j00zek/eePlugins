...
from emukodi import xbmcaddon, xbmcplugin
import emukodi.xbmcgui as xbmc_gui
...
def translatePath(url, asURL=False):
    ...
    write_log("xbmc.translatePath(%s, asURL=%s)" % (url,str(asURL)))
    xurl = url
               
    if "special://home/addons/" in url:
        url = url.replace("special://home/addons/", "/usr/lib/python%s/site-packages/emukodi/PluginsSettings" % pythonVersion)
