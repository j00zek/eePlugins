...
class emukodiConsole(Screen):
    if getDesktop(0).size().width() >= 1920:
        skin = """
          <screen name="emukodiConsole" position="center,center" size="600,400" title="Command execution...">
            <widget name="text" position="0,0" size="800,400" font="Console;28" backgroundColor="background" transparent="1"/>
          </screen>"""
    else:
        skin = """
          <screen position="40,300" size="center,center" title="Command execution..." >
            <widget name="text" position="0,0" size="700,400" font="Console;18" />
          </screen>"""
