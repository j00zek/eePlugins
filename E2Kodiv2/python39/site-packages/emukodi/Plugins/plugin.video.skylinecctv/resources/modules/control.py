...
integer = 1000
lang = xbmcaddon.Addon(id='plugin.video.skylinecctv').getLocalizedString
setting = xbmcaddon.Addon(id='plugin.video.skylinecctv').getSetting
setSetting = xbmcaddon.Addon(id='plugin.video.skylinecctv').setSetting
addon = xbmcaddon.Addon
addonInfo = xbmcaddon.Addon(id='plugin.video.skylinecctv').getAddonInfo
