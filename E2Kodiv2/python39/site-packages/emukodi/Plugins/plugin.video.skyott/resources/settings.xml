<settings>
    ...
    <category label="30002">
        <setting label="30011" type="bool" id="manifest_modification" default="false"/>
        <setting label="30034" type="bool" id="fix_languages" default="false" enable="eq(-1,true)" subsetting="true"/>
