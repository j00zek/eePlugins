...
for pTa in ['/usr/lib/enigma2/python/Plugins/Extensions/E2Kodi/site-packages/emukodi',
            '/usr/lib/enigma2/python/Plugins/Extensions/E2Kodi/site-packages/emukodi/Plugins/script.module.js2py/lib/',
            '/usr/lib/enigma2/python/Plugins/Extensions/E2Kodi/site-packages/emukodi/Plugins/script.module.pyjsparser/lib/',
            '/usr/lib/enigma2/python/Plugins/Extensions/E2Kodi/site-packages/emukodi/Plugins/script.module.tzlocal/lib/',
           ]:
  if pTa not in sys.path:
    sys.path.insert(0,pTa)
