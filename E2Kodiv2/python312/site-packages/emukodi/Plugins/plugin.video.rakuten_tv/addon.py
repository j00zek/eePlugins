...
def create_m3u():
    ...
    for d in resp['data']:
        ...
        dataE2 += 'plugin.video.rakuten_tv/addon.py%3fmode=playSource&cid=' + '%s&lang=%s:%s\n' % (cid, lang, cName) #j00zek for E2 bouquets
    ...
    f.write(dataE2)
    f.close()
    xbmcgui.Dialog().notification('Rakuten TV', 'Wygenerowano listę E2B', xbmcgui.NOTIFICATION_INFO)
